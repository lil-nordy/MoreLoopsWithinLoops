...
def vee(r):
    ...
    for k in range(r):
        ...
        print('-', end='')
        for i in range(r - k):
            print(r - i - k, end='')# try: print(r - i), print(r - k), print(r - i - k)
        print()
...
def numbers_constant_forward(r, maxnum, n):
    ...
    for k in range(r):
        ...
        print()
    # Using the banned string multiplication:
    # print (n) copies of successive integers up to (maxnum) on each of (r) rows. Order: r, manxun, n.
    # for k in range(r):
    #     for i in range(maxnum):
    #         print(str(i + 1) * n, ' ', end='')
    #     print()
...
def numbers_constant_backwards(r, maxnum, n):
    ...
    """
    # ------------------------------------------------------------------
    # DONEs module, as doing so would
    #   defeat the goal of providing practice at loops within loops.
    # ------------------------------------------------------------------
    for k in range(r):
        for i in range(maxnum):
...
def numbers_increasing_forward(r, maxnum):
    ...
    for k in range(r):
        for i in range(maxnum):
            ...
            print(' ', end='')
        print()
    # you solved this problem without any concious thought. You need to be able to do some proofs of thsi shit.
